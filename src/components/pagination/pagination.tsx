    ...
    pageButtons.push(
      <li key={page}>
        <button
          ...
          className={` flex items-center px-2 py-1 w-full h-full border-2 transition-all border-l-0 border-[--main-yellow] hover:bg-[--main-yellow] text-black  bg-[--main-yellow] ${
            isCurrentPage ? 'bg-[--main-yellow]' : 'bg-white'
          }`}
        >
          {page + 1}
        </button>
